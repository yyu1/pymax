...
#-----------Settings-----------------
in_sample_file = '/nobackup/yyu1/samples/agb_train_v6/maxent_train_agb_v6_nam_train.csv'
#in_sample_file = 'sample_train.csv'

layer_dir = '/nobackupp6/nexprojects/CMS-ALOS/maxent/layers/binary/nam'
layer_files = [
	'alos_2007_global_3sec_hh_cut_nam.int',
	'alos_2007_global_3sec_hv_cut_nam.int',
	'alos_2007_global_3sec_mask_cut_nam.byt',
	'global_srtm3_aster_dem_modgrid100m_nam.int',
	'global_srtm3_aster_stdev_modgrid100m_nam.int',
	'tm2015_nir_modgrid100m_nam.byt',
	'tm2015_swirb5_modgrid100m_nam.byt',
	'tm2015_swirb7_modgrid100m_nam.byt']
nlayers = len(layer_files)

xdim = np.uint64(120000)
ydim = np.uint64(79200)

ulmapx = np.float64(-13343313.165637499)
ulmapy = np.float64(8450731.28645835)
...
n_background_pts = np.uint32(4000000)
out_sample_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/nam/nam_train_v6.swd.csv'
out_background_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/nam/nam_background_0.002.swd.csv'
