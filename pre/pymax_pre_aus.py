...
#-----------Settings-----------------
in_sample_file = '/nobackup/yyu1/samples/agb_train_v6/maxent_train_agb_v6_aus_train.csv'
#in_sample_file = 'sample_train.csv'

layer_dir = '/nobackupp6/nexprojects/CMS-ALOS/maxent/layers/binary/aus'
layer_files = [
	'alos_2007_global_3sec_hh_cut_aus.int',
	'alos_2007_global_3sec_hv_cut_aus.int',
	'alos_2007_global_3sec_mask_cut_aus.byt',
	'global_srtm3_aster_dem_modgrid100m_aus.int',
	'global_srtm3_aster_stdev_modgrid100m_aus.int',
	'tm2015_nir_modgrid100m_aus.byt',
	'tm2015_swirb5_modgrid100m_aus.byt',
	'tm2015_swirb7_modgrid100m_aus.byt']
nlayers = len(layer_files)

xdim = np.uint64(108000)
ydim = np.uint64(55200)

ulmapx = np.float64(10007647.834364168)
ulmapy = np.float64(-1112043.2093624999)
...
n_background_pts = np.uint32(700000)
out_sample_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/aus/aus_train_v6.swd.csv'
out_background_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/aus/aus_background_0.002.swd.csv'
