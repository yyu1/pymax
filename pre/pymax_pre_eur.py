...
#-----------Settings-----------------
in_sample_file = '/nobackup/yyu1/samples/agb_train_v6/maxent_train_agb_v6_eur_train.csv'
#in_sample_file = 'sample_train.csv'

layer_dir = '/nobackupp6/nexprojects/CMS-ALOS/maxent/layers/binary/eur'
layer_files = [
	'alos_2007_global_3sec_hh_cut_eur.int',
	'alos_2007_global_3sec_hv_cut_eur.int',
	'alos_2007_global_3sec_mask_cut_eur.byt',
	'global_srtm3_aster_dem_modgrid100m_eur.int',
	'global_srtm3_aster_stdev_modgrid100m_eur.int',
	'tm2015_nir_modgrid100m_eur.byt',
	'tm2015_swirb5_modgrid100m_eur.byt',
	'tm2015_swirb7_modgrid100m_eur.byt']
nlayers = len(layer_files)

xdim = np.uint64(168000)
ydim = np.uint64(43200)

ulmapx = np.float64(-2223808.4156375)
...
out_sample_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/eur/eur_train_v6.swd.csv'
out_background_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/eur/eur_background_0.002.swd.csv'
