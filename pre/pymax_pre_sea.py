...
#-----------Settings-----------------
in_sample_file = '/nobackup/yyu1/samples/agb_train_v6/maxent_train_agb_v6_sea_train.csv'
#in_sample_file = 'sample_train.csv'

layer_dir = '/nobackupp6/nexprojects/CMS-ALOS/maxent/layers/binary/sea'
layer_files = [
	'alos_2007_global_3sec_hh_cut_sea.int',
	'alos_2007_global_3sec_hv_cut_sea.int',
	'alos_2007_global_3sec_mask_cut_sea.byt',
	'global_srtm3_aster_dem_modgrid100m_sea.int',
	'global_srtm3_aster_stdev_modgrid100m_sea.int',
	'tm2015_nir_modgrid100m_sea.byt',
	'tm2015_swirb5_modgrid100m_sea.byt',
	'tm2015_swirb7_modgrid100m_sea.byt']
nlayers = len(layer_files)

xdim = np.uint64(144000)
ydim = np.uint64(60000)

ulmapx = np.float64(6671795.8343625)
ulmapy = np.float64(4447709.6656375)
...
n_background_pts = np.uint32(2000000)
out_sample_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/sea/sea_train_v6.swd.csv'
out_background_file = '/nobackupp6/nexprojects/CMS-ALOS/maxent/swd/v6/sea/sea_background_0.002.swd.csv'
